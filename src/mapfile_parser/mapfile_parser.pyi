...
class MapFile:
    ...
    def writeObjdiffReportToFile(self, outpath: Path, prefixes_to_trim: list[str], report_categories: ReportCategories, asmPath: Path, aliases: dict[str, str]=dict(), pathIndex: int=2) -> None: ...
