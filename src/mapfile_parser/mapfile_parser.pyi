...
class MapFile:
    ...
    def writeObjdiffReportToFile(self, outpath: Path, prefixes_to_trim: list[str], asmPath: Path, nonmatchings: Path, aliases: dict[str, str]=dict(), pathIndex: int=2, checkFunctionFiles: bool=False) -> None: ...
